...
public class ExpressPiecesDetailsChartsFragementActivity extends FragmentActivity {
    /**
     * 作为页面容器的ViewPager
     */
     ...
     * 四个Fragment（页面）
     */
    ExpressPieceDetailsZhuFragment zhuFragment;
    ExpressPieceDetailsZheFragment zheFragement;
    //屏幕宽度
    int screenWidth;
    //当前选中的项
    int currenttab=-1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        zhuFragment=new ExpressPieceDetailsZhuFragment();
        zheFragement=new ExpressPieceDetailsZheFragment();
