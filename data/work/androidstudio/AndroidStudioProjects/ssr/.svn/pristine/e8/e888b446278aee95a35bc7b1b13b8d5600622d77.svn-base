...
public class FinancialSalaryStatisticsAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.baseSalary.setText(this.list.get(position).getSalary());
        viewHolder.baseSalary.setTextSize(13);
        viewHolder.tralAllowance.setText(this.list.get(position).getChucaibuzhu());
        viewHolder.tralAllowance.setTextSize(13);
        viewHolder.bonuxWage.setText(this.list.get(position).getJiangjingongzi());
        viewHolder.bonuxWage.setTextSize(13);
        viewHolder.travelAllowance.setText(this.list.get(position).getJiaotongbuzhu());
        viewHolder.travelAllowance.setTextSize(13);
        viewHolder.overtimePremium.setText(this.list.get(position).getJiabanbuzhu());
        viewHolder.overtimePremium.setTextSize(13);
        viewHolder.reimburse.setText(this.list.get(position).getBaoxiao());
        viewHolder.reimburse.setTextSize(13);
        viewHolder.grossIncome.setText(this.list.get(position).getQuanegongzi());
        viewHolder.grossIncome.setTextSize(13);
        viewHolder.sickLeavePay.setText(this.list.get(position).getBingshijiagongzi());
        viewHolder.sickLeavePay.setTextSize(13);
        viewHolder.housingFund.setText(this.list.get(position).getZhufanggongjijin());
        viewHolder.housingFund.setTextSize(13);
        viewHolder.medicalInsurance.setText(this.list.get(position).getYanglaobaoxian());
        viewHolder.medicalInsurance.setTextSize(13);
        viewHolder.unemploymentInsurance.setText(this.list.get(position).getYiliaobaoxian());
        viewHolder.unemploymentInsurance.setTextSize(13);
        viewHolder.taxableIncome.setText(this.list.get(position).getShiyebaoxian());
        viewHolder.taxableIncome.setTextSize(13);
        viewHolder.endowmentInsurance.setText(this.list.get(position).getYingshuisuodee());
        viewHolder.endowmentInsurance.setTextSize(13);
        viewHolder.personalIncomeTax.setText(this.list.get(position).getGesui());
        viewHolder.personalIncomeTax.setTextSize(13);
        viewHolder.netPayment.setText(this.list.get(position).getShifagongzi());
