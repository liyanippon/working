...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath() %>/common/css/bootstrap.min.css">                                      <!-- Bootstrap style -->
    <link rel="stylesheet" href="<%=request.getContextPath() %>/common/css/templatemo-style.css">                                   <!-- Templatemo style -->
    ...
    <body>
        ...
        <div class="tm-home-img-container">
            <img src="<%=request.getContextPath() %>/common/style/img/tm-home-img.jpg" alt="Image" class="hidden-lg-up img-fluid">
        </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                        ...
                        <div class="tm-content-box">
                            <img src="<%=request.getContextPath() %>/common/style/img/tm-img-310x180-1.jpg" alt="Image" class="tm-margin-b-20 img-fluid">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                        ...
                        <div class="tm-content-box">
                            <img src="<%=request.getContextPath() %>/common/style/img/tm-img-310x180-2.jpg" alt="Image" class="tm-margin-b-20 img-fluid">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                        ...
                        <div class="tm-content-box">
                            <img src="<%=request.getContextPath() %>/common/style/img/tm-img-310x180-3.jpg" alt="Image" class="tm-margin-b-20 img-fluid">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                        ...
                        <div class="tm-content-box">
                            <img src="<%=request.getContextPath() %>/common/style/img/tm-img-310x180-4.jpg" alt="Image" class="tm-margin-b-20 img-fluid">
                ...
                <div class="row tm-margin-t-big">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                        <div class="tm-2-col-left">
                            ...
                            <img src="<%=request.getContextPath() %>/common/style/img/tm-img-660x330-1.jpg" alt="Image" class="tm-margin-b-40 img-fluid">
                            <p>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        ...
                                        <div class="media tm-related-post">
                                          <div class="media-left media-middle">
                                            <a href="#">
                                              <img class="media-object" src="<%=request.getContextPath() %>/common/style/img/tm-img-240x120-1.jpg" alt="Generic placeholder image">
                                            </a>
                                          </div>
                                        ...
                                        <div class="media tm-related-post">
                                          <div class="media-left media-middle">
                                            <a href="#">
                                              <img class="media-object" src="<%=request.getContextPath() %>/common/style/img/tm-img-240x120-2.jpg" alt="Generic placeholder image">
                                            </a>
                                          </div>
                                          <div class="media-body">
                                            <a href="#"><h4 class="media-heading tm-gold-text tm-margin-b-15">Lorem ipsum dolor</h4></a>
                                        ...
                                        <div class="media tm-related-post">
                                          <div class="media-left media-middle">
                                            <a href="#">
                                              <img class="media-object" src="<%=request.getContextPath() %>/common/style/img/tm-img-240x120-3.jpg" alt="Generic placeholder image">
                                            </a>
                                          </div>
                                          <div class="media-body">
                                            <a href="#"><h4 class="media-heading tm-gold-text tm-margin-b-15">Lorem ipsum dolor</h4></a>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                        ...
                        <div class="tm-footer-content-box">
                            ...
                            <div class="tm-margin-b-30">
                                <img src="<%=request.getContextPath() %>/common/style/img/tm-img-100x100-1.jpg" alt="Image" class="tm-footer-thumbnail">
                                <img src="<%=request.getContextPath() %>/common/style/img/tm-img-100x100-2.jpg" alt="Image" class="tm-footer-thumbnail">
                                <img src="<%=request.getContextPath() %>/common/style/img/tm-img-100x100-3.jpg" alt="Image" class="tm-footer-thumbnail">
                                <img src="<%=request.getContextPath() %>/common/style/img/tm-img-100x100-4.jpg" alt="Image" class="tm-footer-thumbnail">
                                <img src="<%=request.getContextPath() %>/common/style/img/tm-img-100x100-5.jpg" alt="Image" class="tm-footer-thumbnail">
                                <img src="<%=request.getContextPath() %>/common/style/img/tm-img-100x100-6.jpg" alt="Image" class="tm-footer-thumbnail">
                            </div>
        ...
        <!-- load JS files -->
        <script src="<%=request.getContextPath() %>/common/js/jquery-1.11.3.min.js"></script>             <!-- jQuery (https://jquery.com/download/) -->
        <script src="<%=request.getContextPath() %>/common/js/tether.min.js"></script> <!-- Tether for Bootstrap, http://stackoverflow.com/questions/34567939/how-to-fix-the-error-error-bootstrap-tooltips-require-tether-http-github-h --> 
        <script src="<%=request.getContextPath() %>/common/js/bootstrap.min.js"></script>                 <!-- Bootstrap (http://v4-alpha.getbootstrap.com/) -->
