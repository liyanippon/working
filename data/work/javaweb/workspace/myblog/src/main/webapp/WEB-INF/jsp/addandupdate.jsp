...
<body>
    ...
    <form id="formid"  name= "myform" method = 'post' action = '${pageContext.request.contextPath }/user/save?type=${requestScope.title}' onsubmit = "return checkUser();">
            <div class="form1">
              <dl>
                <dt>姓名</dt>
                <dd>
              ...
              <dl>
                ...
                <dd>
                    <input  class="textinput" type="submit" value="${requestScope.buttontext}" id="register"  />
                </dd>
                </dl>
             </div>
    </form>
