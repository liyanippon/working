...
public class ExpressPiecesChartsFragementActivity extends FragmentActivity {
    /**
     * 作为页面容器的ViewPager
     */
     ...
     * 四个Fragment（页面）
     */
    ExpressPieceZhuFragment zhuFragment;
    ExpressPieceZheFragment zheFragement;
    //屏幕宽度
    int screenWidth;
    //当前选中的项
    int currenttab=-1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        zhuFragment=new ExpressPieceZhuFragment();
        zheFragement=new ExpressPieceZheFragment();
