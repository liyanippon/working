...
public class ZheeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zhee);

        mCombinedChart = (LineChart) findViewById(R.id.lineChart);
        setGrayValue();
        initData();
    ...
    private void initData() {
        mCombinedChartUtil = new CombinedBarChartUtil(ZheeActivity.this);
